...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 py-20 overflow-hidden">
      ...
      <Sparkles className="floating-icon bottom-[30%] left-[5%] text-primary/60 animate-float-slow hidden md:block" size={32} />
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        <motion.h1 initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease, delay: 0.1 }} className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mt-8">
          <span className="gradient-text">AI-powered exam preparation</span>
          <br />
          <span className="text-foreground">from your PDFs.</span>
        </motion.h1>

        <motion.p initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease, delay: 0.2 }} className="text-lg md:text-xl text-text-muted max-w-2xl mx-auto mt-6 leading-relaxed">
          Upload your study material and instantly generate exam-ready answers, summaries, and mark-based responses.
        </motion.p>

        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease, delay: 0.3 }} className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease, delay: 0.4 }} className="flex items-center justify-center gap-3 mt-6">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, ease, delay: 0.5 }} className="relative mt-16 mx-auto max-w-5xl">
